...
// @Component({
//   selector: 'app-patient_infor',
//   templateUrl: './patient_infor.component.html',
//   styleUrls: ['./patient_infor.component.css']
// })
// export class PatientInforComponent {
...
export class PatientInforComponent implements OnInit{
